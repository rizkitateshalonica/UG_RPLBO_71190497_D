...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71190947 = new User("Rizkita Teshalonica", "rizkita.teshalonica@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71190497 = new GoPay(U_71190947);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71190497.getUser().getNama()+"] - ");
        E_71190497.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71190497.getUser().getNama()+"] - ");
        E_71190497.topup(50000);
        System.out.print("["+E_71190497.getUser().getNama()+"] - ");
        E_71190497.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71190497, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71190497.getUser().getNama()+"] - ");
        E_71190497.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71190497.getUser().getNama()+"] - ");
        E_71190497.withdraw(1100);
